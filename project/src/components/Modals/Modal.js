            ...
            <div className="product_area">
              ...
              <div className="infoArea">
                ...
                <div className="infoPrice">
                  <span className="priceNumber">{info.PROD_PRICE}</span>
                  <span className="priceText"> 원</span>
                  <p className="dayPrice">
                    하루 <span className="dayNumber">{info.PROD_DAYPRICE + '원'}</span> 30일분
                  </p>
                </div>
                <div className="infoCategory">
                  <div className="taking">
                    <div className="categoryImg">
                      <div className="categoryBgc">
                        <img src="https://www.mypuzzle.co.kr/resources/images/icon/product/icn_ingest_info_cap_01.svg" />
                      </div>
                    </div>
                  ...
                  <div className="func">
                    <div className="categoryImg">
                      <div className="categoryBgc">
                        <img src="https://www.mypuzzle.co.kr/resources/images/icon/health/icn_nutritional.svg" />
                      </div>
                    </div>
                    <div className="textSuck">
                      <p>기능</p>
                ...
                <div className="purchase">
                  <button className="purchaseBtn" onClick={infoOut}>
                    장바구니 추가
                  </button>
                </div>
